...
class ReplyMessageBubble extends StatefulWidget {
  ...
  String? replyText;
  @override
  State<ReplyMessageBubble> createState() => _ReplyMessageBubbleState();
}
          ...
          children: <Widget>[
            Container(
              child: Visibility(
                  ...
                  child: TextButton(
                      onPressed: () {
                        replyReturn = replyExtension();
                        widget.callback!(
                            replyReturn, true, widget.text, widget.sender);
                      },
                      child: Icon(
                        Icons.reply,
                        size: 50,
            ...
            Material(
              ...
              child: TextButton(
                  ...
                  child: Padding(
                    padding: widget.sender! == auth.currentUser!.email
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Material(
                            ...
                            // widget.replySender! == auth.currentUser!.email
                            //     ? Colors.lightBlueAccent
                            //     : colorMap[widget.replySender],
                            child: Padding(
                              padding: const EdgeInsets.fromLTRB(10, 2, 10, 6),
                              child: Column(
                                  crossAxisAlignment: widget.replySender! ==
                                  ...
                                  children: <Widget>[
                                    Text(
                                      widget.replySender! ==
                                              auth.currentUser!.email
                                          ? ''
                                          : widget.replySender!.substring(0,
                                              widget.replySender!.indexOf('@')),
                                      style: const TextStyle(
